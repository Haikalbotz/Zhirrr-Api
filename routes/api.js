...
var creatorList = ['@haikaljalk','@haikal"gaje','@zhirr_ajalah','@haikalmiya', '@ms.miya','@heromiya','@haikal'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'gak punya apikey? chat gw aja yaaa di wa.me/6281514320594 , key nya gratis kok gan, jadi santuyy ajaa'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Haikal_Baja'+'Haikal--nggakGans';
